    ...
    <>
      <div className="flex bg-slate-300 h-screen w-screen">
        ...
        <div className="flex flex-row w-full h-full items-center justify-center">
          <div className="flex flex-col h-[60vh] bg-white items-start justify-start w-[25vw] rounded-lg pl-5 pt-4 space-y-8 overflow-y-auto">
            {tempObj ? (
              <div className="mx-auto w-full space-y-8 p-5">
                ...
                <div>
                  ...
                  <button 
                    ...
                    className="bg-green-500 text-white mt-4 px-4 py-2 rounded flex items-center justify-center"
                  >
